...
# Remove any file logging configuration
LOGGING = {
    'version': 1,
...
OTEL_PYTHON_DJANGO_INSTRUMENT_MIDDLEWARE = True
OTEL_PYTHON_DJANGO_INSTRUMENT_TEMPLATES = True
OTEL_PYTHON_DJANGO_INSTRUMENT_SIGNALS = True
OTEL_PYTHON_DJANGO_INSTRUMENT_CACHE = True
OTEL_PYTHON_DJANGO_INSTRUMENT_LOGGING = True
